    ...
    public function run()
    {
        ServiceFaq::insert([
            [
                ...
                'answer' => null,
                'link' => 'https://bit.ly/ADR-Jasa',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
                'faqj_id' => 'FQB-00002',
                'question' => 'Joki sperti apa saja?',
                'answer' => '<ul>
                    <li>Tugas Harian</li>
                    <li>Pre-test</li>
                    <li>Post-test</li>
                    ...
                    <li>Aplikasi untuk digunakan sendiri (di perusahaan)</li>
                </ul>',
                'link' => null,
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ...
            [
                ...
                'answer' => 'Silahkan kirim detail tugas / instruksi dari dosennya, nanti akan kami baca dan harganya akan keluar. <b>Alur lengkapnya silahkan cek poin 6.</b>',
                'link' => null,
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            ...
            [
                ...
                'answer' => 'Maaf, tidak bisa. Silahkan baca kembali poin 6!',
                'link' => null,
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
